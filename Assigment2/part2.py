...
Developing voting algorithm using 5 classifiers and the best hyperparameters
...
if __name__ == '__main__':
    ...
    cm = confusion_matrix(test_classes ,y_pred, normalize='true')

    # Visualize confusion matrix using heatmap
    sns.heatmap(cm, annot=True, cmap='Blues', fmt='.2%', cbar=False, xticklabels=['Not-FOG','FOG'], yticklabels=['Not-FOG','FOG'])
...
Micro-F1: 0.9154929577464789
Macro-F1: 0.9154761904761904
Precision: [0.91666667 0.91428571]
Recall: [0.91666667 0.91428571]
